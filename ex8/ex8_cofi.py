...
def costFunc(p): return cofiCostFunc(
    p, Ynorm, R, num_users, num_movies, num_features, Lambda)[0]


def gradFunc(p): return cofiCostFunc(
    p, Ynorm, R, num_users, num_movies, num_features, Lambda)[1]
